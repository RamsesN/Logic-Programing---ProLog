...
setup(Castle) :-  /* a list of 8 variables */  Castle = [NW,N,NE,E,SE,S,SW,W], 
 
 /* each variable is an integer between 0 and 12 */  Castle :: 0..12, 
...
solve2(Castle) :-  Castle = [NW,N,NE,E,SE,S,SW,W],  Middles #= N+W,  minimize(labeling(Castle),Middles).  
 
printC(Castle) :-  Castle = [NW,N,NE,E,SE,S,SW,W],  printf("%3d%3d%3d\n", [NW,N,NE]),  printf("%3d   %3d\n", [ W,   E]),  printf("%3d%3d%3d\n", [SW,S,SE]).